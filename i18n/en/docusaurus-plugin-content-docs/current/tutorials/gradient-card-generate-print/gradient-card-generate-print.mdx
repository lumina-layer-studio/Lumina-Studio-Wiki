...
> **AI translation notice:** This English tutorial was translated from the original Chinese tutorial with AI assistance. The English narration and subtitles were also produced with AI assistance. If any wording is unclear, please refer to the [Chinese tutorial](https://wiki.luminastudio.com.cn/zh/docs/tutorials/gradient-card-generate-print) or leave a comment.
